...
\end{lem}
\begin{proof}
Без док-ва\footnote{Для док-ва надо получить, что $\frac{\partial^2}{\parital\lambda_i\partial x_j}\tilde{M}} > 0$ и воспользоваться тем, что элементы $P^{-1}$ из теоремы о структуре матрицы Якоби будут отрицательными.}
\end{proof}
